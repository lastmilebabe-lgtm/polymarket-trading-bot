    ...
    while True:
        try:
            ...
            if slug != current_slug:
                ...
                # If not ready, try next window (common for rolling 15m markets)
                ...
                print(f"🔍 Tokens: {len(tokens)} found for {slug}")
            ...
            if total <= cheap_threshold:
                ...
                # TODO: Add your buy code here using bot
            else:
...
def fetch_market(slug: str):
    """Simple helper to fetch market by slug"""
